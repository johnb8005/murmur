...
// Inline SVG icons (Lucide-style paths) so the app has no icon font to fetch and works offline.
const paths: Record<string, React.ReactNode> = {
  ...
  trash: <path d="M3 6h18M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2m2 0v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6" />,
  rss: (
    <>
  ...
  refresh: <path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8M3 3v5h5M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16M16 16h5v5" />,
  settings: (
    <>
...
export const Icon = ({ name, size = 18, filled = false, className = "" }: { name: IconName; size?: number; filled?: boolean; className?: string }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
